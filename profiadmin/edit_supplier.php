                        ...
                        <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                                ...
                                ?>
                            	 <form role="form" action="ubah_supplier.php?id=<?php echo $data['id_supplier']?>" method="post">
                            	 	<div class="form-group">
                            	 		<label>Kode Supplier</label>
                            	 		<input class="form-control" name="kode" placeholder="enter text" value="<?php echo $data['Kd_Supplier']?>" readonly>
                            	 	</div>
                            	 	<div class="form-group">
                            	 		<label>Nama Supplier</label>
                            	 		<input class="form-control" name="supplier" value="<?php echo $data['Nama_Supplier']?>">
                            	 	</div>
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <textarea name="alamat" id="alamat" class="form-control" value="<?php echo $data['Alamat']?>"></textarea> -->
                                    </div>
                            	 	<div>
