                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                           <?php
                              $kode_cst = mysql_query("SELECT `id_kategori` FROM `tbl_kategori` ORDER BY `id_kategori` DESC LIMIT 0,1"); 
                              $data_cst = mysql_fetch_array($kode_cst);
                              $Kode_Kategori = $data_cst['id_kategori'] + 1;
                           ?>
                           <form role="form" action="tambah_kategori.php" method="post">
									                <div class="form-group">
                                        <label>Kode Kategori</label>
                                        <input type="text" name="kode" value="<?php echo "0".$Kode_Kategori ?>" readonly class="form-control"> 
                                    </div>  
                                    <div class="form-group">
                                        <label>Kategori</label>
                                        <input class="form-control" name="kategori" placeholder="Enter text" >
                                    </div>                       
