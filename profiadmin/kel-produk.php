          ...
          <div class="row">
 		  ...
 		  <div class="row">
            <div class="col-lg-12">
               ...
               Tambah Data Produk :&nbsp;<a href="add_barang.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                             <table class="table table-striped table-border table-hover">
                               <thead>
                                <tr>
                                 <th width="15"><div align="center">No.</div></th>
                                 <th width="85"><div align="center">Nama</div></th>
                                 <th width="185"><div align="center">Deskripsi</div></th>
                                 <th width="85"><div align="center">Kategori</div></th>
                                 <th width="50"><div align="center">Suplier</div></th>
                                 <th width="125"><div align="center">Tanggal Beli</div></th>
                                 <th width="85"><div align="center">Stok</div></th>
                                 <th width="100"><div align="center">Harga Beli</div></th>
                                 <th width="100"><div align="center">Harga Jual</div></th>
                                 <th width="85"><div align="center">Foto</div></th>
                               </tr>
                               </thead>
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM `tbl_produk` ORDER BY `Kd_Barang`";
                                    $query = "SELECT * FROM `tbl_produk` ORDER BY `id_barang`LIMIT $offset, $dataPerPage";
                                    ...
                                    While ($data = mysql_fetch_array($result)){
                                      ...
                                      <td><div align="left"><?php echo $data['Deskripsi'] ?></div></td>
                                      <td><div align="center"><?php echo $data['Kd_Kategori'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Kd_Supplier'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Tanggal_Beli'] ?></div></td>
                                      <td><div align="center"><?php echo $data['Stok'] ?></div></td>
                                      <td><div align="right"><?php echo $data['Harga_Beli'] ?></div></td>
                                      <td><div align="right"><?php echo $data['Harga_Jual'] ?></div></td>
                                      <td><div align="center"><img src="produk/<?php echo $data['Foto'] ?>" width="80"></div></td>
                                      <td align="center">
                                        <a href="edit_pro.php?id=<?php echo $data['id_barang']?>"><img src="assets/img/edit.png" width="20"></a>&nbsp;
                                      </td><td>
                                        <a href="hapus-pro.php?id=<?php echo $data['id_barang']?>">
