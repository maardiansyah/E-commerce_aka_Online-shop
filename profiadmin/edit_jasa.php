	  ...
	  ?>
       ...
       <div id="content">
          <div class="inner">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ubah Data Jasa Pengiriman</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                              <div class="col-lg-6">
                            	<?php 
                            		$query = "SELECT*FROM tbl_jasakirim WHERE id_jasa = '".$_REQUEST['id']."'";
                            		$result = mysql_query($query); //xecute the query
                            		$data = mysql_fetch_array($result);
                                ?>
                            	 <form role="form" action="ubah_jasa.php?id=<?php echo $data['id_jasa']?>" method="post">
                            	 	<div class="form-group">
                            	 		<label>Kode Jasa</label>
                            	 		<input class="form-control" name="kode" placeholder="enter text" value="<?php echo $data['Kd_Jasa']?>" readonly>
                            	 	</div>
                            	 	<div class="form-group">
                            	 		<label>Nama Jasa</label>
                            	 		<input class="form-control" name="nama" value="<?php echo $data['Nama_Jasa']?>">
                            	 	</div>
                                 <div class="form-group">
                            	 		<label>Durasi</label>
                            	 		<input name="durasi" class="form-control" placeholder="Enter text" value="<?php echo $data['Durasi']?>">
                            	 	</div>
                            	 	<div class="form-group">
                            	 		<label>Biaya Jasa</label>
                            	 		<input name="ongkir" class="form-control" placeholder="Enter text" value="<?php echo $data['Ongkir']?>">
                            	 	</div>
                            	 	<div>
