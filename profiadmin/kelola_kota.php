...
<script type="text/javascript">
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Kota Dengan Kode Kota : '+id+' ?'))
         {
          window.location.href='delete_kota.php?delete_id='+id;
         }
     }
</script>
</head>
  ...
  <div id="wrap">
     <div id="top">
        <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
           ...
           <header class="navbar-header"><a href="../profiadmin/" class="navbar-brand">
                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data Kota&nbsp;:&nbsp;<a href="add_kota.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                          <table class="table table-striped table-bordered table-hover">
                               <thead>
                                <tr>
                                 <th width="25"><div align="center">No.</div></th>
                                 <th width="50"><div align="center">Kode Kota</div></th>
                                 <th width="85"><div align="center">Nama Kota</div></th>
                               ...
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM tbl_kota";
                                    $query = "SELECT * FROM tbl_kota ORDER BY id_kota LIMIT $offset, $dataPerPage";
                                    ...
                                    While ($data = mysql_fetch_array($result)){
                                      ...
                                      <td><div align="left"><?php echo $data['Kd_Kota'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Kota'] ?></div></td>
                                      <td align="center">
                                        <a href="edit_kota.php?id=<?php echo $data['id_kota']?>"><img src="assets/img/edit.png" width="20"></a>&nbsp;
                                        <a href="hapus_kota.php?id=<?php echo $data['id_kota'] ?>">
