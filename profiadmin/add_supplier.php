                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                           <?php
                              $kode_cst = mysql_query("SELECT `id_supplier` FROM `tbl_supplier` ORDER BY `id_supplier` DESC LIMIT 0,1"); 
                              $data_cst = mysql_fetch_array($kode_cst);
                              $Kode_supplier = $data_cst['id_supplier'] + 1;
                           ?>
                           <form role="form" action="tambah_supplier.php" method="post">
									                <div class="form-group">
                                        <label>Kode Supplier</label>
                                        <input type="text" name="kode" value="<?php echo "0".$Kode_supplier ?>" readonly class="form-control"> 
                                    </div>  
                                    <div class="form-group">
                                        <label>Nama Supplier</label>
                                        <input class="form-control" name="supplier" placeholder="Enter text" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" id="supplier" cols="30" rows="3" class="form-control" placeholder="Masukan Alamat"></textarea>
                                    </div>                     
