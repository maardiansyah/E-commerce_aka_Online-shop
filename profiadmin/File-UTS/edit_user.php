                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">   
                             <div class="col-lg-6">
                              <?php
                         $kode_cst = mysql_query("SELECT `Kode_Customer` FROM `tbl_customer` WHERE 'Kode_Customer'"); 
                         $data_cst = mysql_fetch_array($kode_cst);
                     $Kode_Customer = $data_cst['Kode_Customer'+1];
                    ?>
                                <form role="form" action="ubah-user.php" method="POST">
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>Level</label>
                                        <input class="form-control" name="level" placeholder="Enter text">
                                     </div>    
                                     <label>Kode</label>
                                        <input type="text" id="kode" class="form-control" name="kode" placeholder="masukan kode" required>
                                    </div>  
                                     ...
                                     <div class="form-group">
                                        <label>Telp.</label>
                                        <input type="text" name="telp" placeholder="Masukan No. Telp" class="form-control">
                                     </div>   
                                     <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea class="form-control" name="nama" placeholder="Masukan Alamat"></textarea>
                                     </div>                      
