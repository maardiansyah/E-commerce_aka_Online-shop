...
<script type="text/javascript">
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Ketegori Dengan Kode User : '+id+' ?'))
         {
          window.location.href='delete_kategori.php?delete_id='+id;
         }
     }
</script>
</head>
                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data Kategori :&nbsp;<a href="add_kategori.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                     <table class="table table-striped table-bordered table-hover">
                               <thead>
                                <tr>
                                 <th width="25"><div align="center">No.</div></th>
                                 <th width="50"><div align="center">Kode Kategori</div></th>
                               ...
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM tbl_kategori";
                                    $query = "SELECT * FROM tbl_kategori ORDER BY id_kategori LIMIT $offset, $dataPerPage";
                                    ...
                                    While ($data = mysql_fetch_array($result)){
                                      ...
                                      <td><div align="left"><?php echo $data['Kd_Kategori'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Kategori'] ?></div></td>
                                      <td align="center">
                                        <a href="edit_kategori.php?id=<?php echo $data['id_kategori']?>"><img src="assets/img/edit.png" width="20"></a>&nbsp;
