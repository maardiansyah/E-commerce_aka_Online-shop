	  ...
	  ?>
       ...
       <div id="content">
          <div class="inner">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Jasa Pengiriman</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6">
                           <?php
                              $kode_cst = mysql_query("SELECT `id_jasa` FROM `tbl_jasakirim` ORDER BY `id_jasa` DESC LIMIT 0,1"); 
                              $data_cst = mysql_fetch_array($kode_cst);
                              $Kode_Customer = $data_cst['id_jasa'] + 1;
                           ?>
                           <form role="form" action="tambah_jasa.php" method="post">
									                <div class="form-group">
                                        <label>Kode Jasa</label>
                                        <input type="text" name="kode" value="<?php echo "0".$Kode_Customer ?>" readonly class="form-control"> 
                                    </div>  
                                    <div class="form-group">
