...
<script type="text/javascript">
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Jasa Pengiriman Dengan Kode Supplier : '+id+' ?'))
         {
          window.location.href='delete_jasa.php?delete_id='+id;
         }
     }
</script>
</head>
  ...
  <div id="wrap">
    ...
    <div id="content">
       <div class="inner">
          <div class="row">
              <div class="col-lg-12">
                  <h2> KELOLA DATA JASA PENGIRIMAN</h2>
 			  </div>
          </div><hr />
 		  <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                     <div class="panel-body">
						...
						Tambah Data Jasa Pengiriman :&nbsp;<a href="add_jasa.php"><img src="assets/img/add.png" width="20"></br></br></a>
                          <table class="table table-striped table-bordered table-hover">
                               <thead>
                                <tr>
                                 <th width="25"><div align="center">No.</div></th>
                                 <th width="50"><div align="center">Kode Jasa</div></th>
                                 <th width="85"><div align="center">Nama Jasa</div></th>
                                 <th width="100"><div align="center">Durasi</div></th>
                                 <th width="25"><div align="center">Biaya</div></th>
                               ...
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM tbl_jasakirim";
                                    $query = "SELECT * FROM tbl_jasakirim ORDER BY id_jasa LIMIT $offset, $dataPerPage";
                                    ...
                                    While ($data = mysql_fetch_array($result)){
                                      ...
                                      <td><div align="left"><?php echo $data['Kd_Jasa'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Nama_Jasa'] ?></div></td>
                                      <td><div align="left"><?php echo $data['Durasi'] ?></div></td>
                                      <td><div align="center"><?php echo $data['Ongkir'] ?></div></td>
                                      <td align="center">
                                        <a href="edit_jasa.php?id=<?php echo $data['id_jasa']?>"><img src="assets/img/edit.png" width="20"></a>&nbsp;
                                        <a href="hapus_jasa.php?id=<?php echo $data['id_jasa'] ?>">
