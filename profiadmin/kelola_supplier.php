...
<script type="text/javascript">
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data Supplier Dengan Kode Supplier : '+id+' ?'))
         {
          window.location.href='delete_supplier.php?delete_id='+id;
         }
     }
</script>
</head>
                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							Tambah Data Supplier :&nbsp;<a href="add_supplier.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                     <table class="table table-striped table-bordered table-hover">
                               <thead>
                                <tr>
                                 <th width="25"><div align="center">No.</div></th>
                                 <th width="50"><div align="center">Kode Supplier</div></th>
                                 <th width="85"><div align="center">Nama Supllier</div></th>
                                 <th width="85"><div align="center">Telp. Supllier</div></th>
                                 <th width="85"><div align="center">Alamat Supllier</div></th>
                               ...
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM tbl_supplier";
                                    $query = "SELECT * FROM tbl_supplier ORDER BY id_supplier LIMIT $offset, $dataPerPage";
                                    ...
                                    While ($data = mysql_fetch_array($result)){
                                      ...
                                      <td align="center">
                                        <a href="edit_supplier.php?id=<?php echo $data['id_supplier']?>"><img src="assets/img/edit.png" width="20"></a>&nbsp;
                                        <a href="hapus_supplier.php?id=<?php echo $data['id_supplier'] ?>">
