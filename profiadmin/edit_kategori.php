                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                         ...
                         <div class="row">
                              <div class="col-lg-6">
                            	<?php 
                            		$query = "SELECT*FROM tbl_kategori WHERE id_kategori = '".$_REQUEST['id']."'";
                            		$result = mysql_query($query); //xecute the query
                            		$data = mysql_fetch_array($result);
                                ?>
                            	 <form role="form" action="ubah_kategori.php?id=<?php echo $data['id_kategori']?>" method="post">
                            	 	<div class="form-group">
                            	 		<label>Kode Kategori</label>
                            	 		<input class="form-control" name="kode" placeholder="enter text" value="<?php echo $data['Kd_Kategori']?>" readonly>
                            	 	</div>
                            	 	<div class="form-group">
