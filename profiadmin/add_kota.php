	  ...
	  ?>
       ...
       <div id="content">
          <div class="inner">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Kota</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                           <?php
                              $kode_cst = mysql_query("SELECT `id_kota` FROM `tbl_kota` ORDER BY `id_kota` DESC LIMIT 0,1"); 
                              $data_cst = mysql_fetch_array($kode_cst);
                              $Kode_Kategori = $data_cst['id_kota'] + 1;
                           ?>
                           <form role="form" action="tambah_kota.php" method="post">
									                <div class="form-group">
                                        <label>Kode Kota</label>
                                        <input type="text" name="kode" value="<?php echo $Kode_Kategori ?>" readonly class="form-control"> 
                                    </div>  
                                    <div class="form-group">
                                        <label>Nama Kota</label>
                                        <input class="form-control" name="kota" placeholder="Enter text" >
                                    </div>                       
