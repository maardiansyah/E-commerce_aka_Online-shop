                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
							 Tambah Data User :&nbsp;<a href="add_user.php"><img src="assets/img/add.png" width="20"></br></br></a> 
                            <table class="table table-striped table-bordered table-hover">
                               ...
                               <tbody>
                                 <?php 
                                    ...
                                    $total_data="SELECT COUNT(*) AS jumData FROM tbl_user";
                                    $query = "SELECT * FROM tbl_user ORDER BY Username LIMIT $offset, $dataPerPage";
                                     ...
                                     <tr>
                                       <td colspan="10"><div class="center">
                                         <div class="paginatioan">
                                          ...
                                          // the last page
                                          if ($noPage<$jumPage)
                                            echo "<a href='".$_SERVER['PHP_SELF']."?page=".($jumPage)."'class=active>Next</a>&nbsp&nbsp";
                                            ?>
